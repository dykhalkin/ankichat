...
class TestSRSEngine:
    ...
    def test_process_recall_perfect_second_review(self, sample_card, reference_time):
        ...
        # Second review
        updated_card = SRSEngine.process_recall_result(
            sample_card, RecallScore.PERFECT_RECALL, 
        ...
        assert updated_card.due_date == reference_time + datetime.timedelta(days=1) + datetime.timedelta(days=6)
    ...
    def test_process_recall_perfect_third_review(self, sample_card, reference_time):
        ...
        updated_card = SRSEngine.process_recall_result(
            sample_card, RecallScore.PERFECT_RECALL, 
            reference_time + datetime.timedelta(days=7)
        )
    ...
    def test_process_recall_incorrect(self, sample_card, reference_time):
        ...
        # Now fail the card
        updated_card = SRSEngine.process_recall_result(
            sample_card, RecallScore.COMPLETE_BLACKOUT, 
            reference_time + datetime.timedelta(days=7)
        )
    ...
    def test_int_score_conversion(self, sample_card, reference_time):
        ...
        card2 = SRSEngine.process_recall_result(sample_card2, RecallScore.PERFECT_RECALL, reference_time)
