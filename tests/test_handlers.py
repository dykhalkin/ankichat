...
from src.handlers import (
    start_command, help_command, new_card_command, process_card_text,
    handle_preview_callback, handle_deck_selection, cancel_command,
    AWAITING_CARD_TEXT, AWAITING_CONFIRMATION, AWAITING_DECK_SELECTION,
    CONFIRM_PREFIX, EDIT_PREFIX, DECK_PREFIX, CANCEL_PREFIX
)
...
@pytest.mark.asyncio
async def test_handle_preview_callback_confirm_simple(mock_update_with_callback, mock_context, mock_deck_service):
    ...
    # Mock deck service
    decks = [
        MagicMock(id="deck1", name="Deck 1"),
        MagicMock(id="deck2", name="Deck 2")
    ]
