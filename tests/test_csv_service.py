...
class TestCSVService:
    ...
    def csv_service(self, deck_repo_mock, flashcard_repo_mock, llm_client_mock):
        ...
        service.csv_manager.export_all_decks_to_csv = MagicMock(return_value=["/path/to/exported1.csv", "/path/to/exported2.csv"])
    ...
    async def test_import_with_auto_deck(self, csv_service, temp_csv_file, flashcard_repo_mock):
        ...
        csv_service.import_from_csv = MagicMock(return_value={
            "success": True,
            "cards_imported": 2,
            "decks_created": 1,
            "warnings": []
